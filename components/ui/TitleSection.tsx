  ...
  return (
    <>
      <div className="relative flex items-center gap-5 before:content-[''] before:absolute before:block before:w-1 before:h-3/4 before:bg-teal before:rounded-full">
        <h1 className="ml-3 text-base md:text-xl lg:text-2xl text-white font-semibold ">{title}</h1>

        <div className="w-fit hidden md:block border border-teal text-white rounded-full text-sm text-center z-[1]">
          <button
